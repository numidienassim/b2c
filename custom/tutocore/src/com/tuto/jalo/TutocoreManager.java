...
/**
 * This is the extension manager of the Tutocore extension.
 */
public class TutocoreManager extends GeneratedTutocoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TutocoreManager.class);
	 ...
	 */
	public static TutocoreManager getInstance()
	{
		return (TutocoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TutocoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TutocoreManager() // NOPMD 
	{
		LOG.debug("constructor of TutocoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TutocoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TutocoreManager called, current tenant: {}", getTenant().getTenantID());
	}
