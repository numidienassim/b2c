...
public class DefaultTutocoreService implements TutocoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTutocoreService.class);
	...
	{
		return DefaultTutocoreService.class.getResourceAsStream("/tutocore/sap-hybris-platform.png");
	}
